  ...
  Widget _buildAnimation(BuildContext context, Widget child) {
    return Padding(
      ...
      child: InkWell(
        ...
        child: Hero(//o filho desse widget podera ser passado para as outras telas
            tag: "fade",
  ...
  Widget _buildInside(BuildContext context) {
    if (buttonSqueeze.value > 75) {
      return Text(
        "Sign In",
        style: TextStyle(
            color: Color.fromRGBO(141, 110, 99, 1.0),
            fontSize: 20,
      ...
      return CircularProgressIndicator(
        valueColor:
            AlwaysStoppedAnimation<Color>(Color.fromRGBO(141, 110, 99, 1.0)),
        strokeWidth: 1.0,
      );
    }
  }
